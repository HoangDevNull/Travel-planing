...
export const HeadSessions = () => {
  ...
  return (
    <>
      ...
      <Grid container justify="space-between" className={classes.bottom_action}>
        <Button
          color="secondary"
          size="large"
          startIcon={
            <FontAwesomeIcon size="lg" icon={['fas', 'long-arrow-alt-left']} />
          }
        ...
        <Button
          ...
          size="large"
          endIcon={
            <FontAwesomeIcon size="lg" icon={['fas', 'long-arrow-alt-right']} />
          }
          className={classes.btn_arrow}
        >
          <Typography
